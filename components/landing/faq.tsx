...
const questions = [
  { question: "Minhas imagens são enviadas para algum servidor?", answer: "Não. A leitura, o redimensionamento e a codificação acontecem integralmente no navegador. O servidor entrega apenas a interface da aplicação." },
  ...
  { question: "Quais formatos posso gerar?", answer: "Você pode exportar WebP, AVIF, PNG, JPG e ICO. A codificação AVIF usa WebAssembly carregado somente quando necessário." },
