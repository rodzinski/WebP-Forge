    ...
    <section className="section-block" id="recursos">
      ...
      <Stagger className="bento-grid">
        ...
        <StaggerItem className="bento-card bento-format">
          <ImageIcon className="size-6" /><div className="format-cloud"><span>WEBP</span><span>AVIF</span><span>PNG</span><span>JPG</span><span>ICO</span></div><h3>Um fluxo.<br />Múltiplos destinos.</h3>
        </StaggerItem>
