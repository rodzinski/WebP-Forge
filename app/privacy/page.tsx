    ...
    <main className="legal-page">
      ...
      <div className="legal-layout">
        ...
        <article className="legal-content">
          ...
          <section><span>04</span><div><h2>Analytics opcional</h2><p>O site oferece métricas agregadas de navegação pelo Cloudflare Web Analytics somente após consentimento explícito. O recurso permanece desativado até que você escolha permitir e pode ser desativado novamente em “Preferências de analytics” no rodapé.</p><p>Não enviamos imagens, nomes de arquivos, configurações de conversão ou histórico. A preferência de consentimento é armazenada localmente no navegador. Não utilizamos essas métricas para publicidade ou criação de perfis individuais.</p></div></section>
