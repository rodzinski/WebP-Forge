  ...
  return <main className="support-page">
    ...
    <section className="support-grid">
      ...
      <div className="support-community">
        <a href={repositoryUrl} target="_blank" rel="noreferrer"><Star className="size-5" /><div><span>01</span><h2>Dê uma estrela</h2><p>Abra o repositório e use o botão Star para ajudar mais pessoas a encontrar o projeto.</p></div><ArrowUpRight className="size-4" /></a>
